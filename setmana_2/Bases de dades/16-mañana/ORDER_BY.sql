...
/* Tabla Customers */
INSERT INTO `poo2022`.`Customers` (`CustomerName`, `ContactName`, `Address`, `City`, `PostalCode`, `Country`) VALUES ('María', 'Juanito Pérez', 'Calle 123 s/n ', 'Madrid', '28001', 'España');
INSERT INTO `poo2022`.`Customers` (`CustomerName`, `ContactName`, `Address`, `City`, `PostalCode`, `Country`) VALUES ('Pepito', 'Mario Martínez', 'Av. de la Programación 098', 'Buenos Aires', '6660', 'Argentina');
INSERT INTO `poo2022`.`Customers` (`CustomerName`, `ContactName`, `Address`, `City`, `PostalCode`, `Country`) VALUES ('Alfonso', 'María Santiago', 'C/ De La Fuente 345', 'Toledo', '45660', 'España');
INSERT INTO `poo2022`.`Customers` (`CustomerName`, `ContactName`, `Address`, `City`, `PostalCode`, `Country`) VALUES ('Mark', 'John Smith', '1253 Crummit Lane', 'Omaha', '68137', 'Estados Unidos');
INSERT INTO `poo2022`.`Customers` (`CustomerName`, `ContactName`, `Address`, `City`, `PostalCode`, `Country`) VALUES ('Andrea', 'Jose Cuervo', 'CIRC JUAN PABLO II NO. 1755 Int. NO. 5', 'Puebla', '72410', 'México');
INSERT INTO `poo2022`.`Customers` (`CustomerName`, `ContactName`, `Address`, `City`, `PostalCode`, `Country`) VALUES ('Alfonso', 'María Santiago', 'C/ De La Fuente 345', 'Toledo', '45660', 'España');
INSERT INTO `poo2022`.`Customers` (`CustomerName`, `ContactName`, `Address`, `City`, `PostalCode`, `Country`) VALUES ('Mark', 'John Smith', '1253 Crummit Lane', 'Omaha', '68137', 'Estados Unidos');
INSERT INTO `poo2022`.`Customers` (`CustomerName`, `ContactName`, `Address`, `City`, `PostalCode`, `Country`) VALUES ('Andrea', 'Jose Cuervo', 'CIRC JUAN PABLO II NO. 1755 Int. NO. 5', 'Puebla', '72410', 'México');
...
-- Ejemplos de ORDER BY -> ASC para ascendente y DESC para descendente
    ...
    SELECT * FROM `poo2022`.Products ORDER BY Price;
    -- Ordenamos por Nombre de Cliente DESC
    SELECT * FROM `poo2022`.Customers ORDER BY CustomerName DESC;

    -- Los queries pueden ser multilínea para leerlos mejor. Ordenamos por Price ASC
    SELECT * FROM `poo2022`.Products 
    ORDER BY Price ASC;  
    ...
    SELECT DISTINCT CustomerName, Address, PostalCode, Country FROM `poo2022`.Customers 
    ...
    SELECT DISTINCT CustomerName, ContactName, Address, PostalCode, Country FROM `poo2022`.Customers 
    WHERE CustomerName LIKE 'a%' AND Country IN ('España', 'Argentina', 'Venezuela', 'Mexico')
