...
function ej2(){
    class Producto {
        constructor(precio = 1, descuento = 0) {
            this.precio = precio;
    ...
    // objetos producto
    let producto = new Producto()  // agafa els valors predefinits de la classe
    let producto2 = new Producto(200)
    let producto3 = new Producto (300, 30)
...
function ej3(){
    class Piedra {
        constructor(color, origen, materiales, masaKg, masaGr, volumenCc) {
            this.color = color;
            this.origen = origen;
        ...
        calcDensidadKgM3 () {
            return (this.masaKg / this.volumenM3).toFixed(5);
        }
        calcDensidadGrCc() {
            return (this.masaGr / this.volumenCc).toFixed(5);
        }
    }   

    let piedra = new Piedra ("vermella", "Volcànica", ["silici", "calci"], 1.5, 1.5*1000, 100, 0.001)
    let piedra2 = new Piedra ("grisa", "subsol", ["quarz", "calci"], 2, 2*1000, 150, 0.002)
