...
INSERT INTO `poo2022`.Products (ProductName, SupplierId, CategoryId, Unit, Price)
...
-- Customers -> hemos colocado CustomerName como NOT NULL (NN) 
    ...
    INSERT INTO `poo2022`.Customers (CustomerName, ContactName, Address, City, PostalCode, Country)
...
INSERT INTO `poo2022`.Customers (CustomerName, Address, City, PostalCode, Country)
...
INSERT INTO `poo2022`.Customers (CustomerName, ContactName, Address, City, PostalCode, Country, Rol)
...
SELECT * FROM `poo2022`.Customers;INSERT INTO `poo2022`.Customers (CustomerName, ContactName, City, PostalCode, Country)
